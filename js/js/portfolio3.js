$("document").ready(function(){
    ...
    let page = new fullpage(".fullpage",{        // scrollBar:true,
        ...
        afterLoad:function(origin,destination){
            ...
            if(destination.index==0){
                ...
                $(".section.portfolio_01 .title p").css("opacity","1")
            ...
            if(destination.index==1){
                ...
                $(".section.portfolio_02 .title p").css("opacity","1")
                $(".nav ul li a").css("color","#fff")
            ...
            if(destination.index==2){
                ...
                $(".fullpage .section.portfolio_03 .about .right .cover").eq(3).mouseover(function(){
                    ...
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress img").css("opacity",1)
                    ...
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress").eq(0).animate({
                        opacity:1
            
                    },1000, function(){
                        pro("#html", 0.9)
                    })
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress").eq(1).animate({
                        opacity:1
                    },1000, function(){
                        pro("#css", 0.9)
                    })
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress").eq(2).animate({
                        opacity:1
                    },1000, function(){
                        pro("#js", 0.6)
                    })
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress").eq(3).animate({
                        opacity:1
                    },1000, function(){
                        pro("#ps", 0.8)
                    })
                    $(".section.portfolio_03 .about .right .bottom .skiils .progress-area .progress").eq(4).animate({
                        opacity:1
                    },1000, function(){
                        pro("#ai", 0.8)
                    })
            ...
            if(destination.index==3){
                ...
                $(".section.portfolio_04 .title p").css("opacity","1")
                $(".nav ul li a").css("color","#fff")
                setTimeout(function(){
            ...
            if(destination.index==7){
                ...
                $(".section.portfolio_08 .title p").css("opacity","1")
                setTimeout(function(){
            ...
            if(destination.index==9){
                ...
                $(".section.portfolio_10 .border .over .mouse").addClass("over")
                $(".section.portfolio_10 .border .over .mouseover").addClass("over")
    ...
    $(" .section.portfolio_10 .border").mouseover(function(){
        ...
        for(let a = 0; a <$(".section.portfolio_10 .background").length; a++){
               ...
               $(".section.portfolio_10 .border .over .mouse").hide();
               $(".section.portfolio_10 .border .over .mouseover").hide();
               $(".section.portfolio_10 .border .over p").hide();
               $(".section.portfolio_10 .border .over .window").hide();
               $(".section.portfolio_10 .border .text-me p").eq(1).css("opacity","1")
               $(".section.portfolio_10 .border .text-me p").eq(2).css("opacity","1")
               $(".section.portfolio_10 .border .text-me p").eq(3).css("opacity","1")
    ...
    $(".fullpage .section.portfolio_09 .menu ul li").click(function(){
        ...
        $(".fullpage .section.portfolio_09 .menu ul li img").removeClass("left").eq(slide_num).addClass("left")
